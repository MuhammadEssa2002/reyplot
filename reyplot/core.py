...
class Legend_layer:
    def __init__(self,legend_layout,positions,limits,display,location,text_color,stroke,stroke_color):
...
class chart:
    ...
    # Legend method
    def legend(self,display = True,location = "top_right",text_color = "black",stroke = True,stroke_color = None):
